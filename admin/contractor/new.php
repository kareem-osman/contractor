...
<div id="main" class="my-5">
  ...
  <div class="id"><h2 class="text-center">Add New Contractor</h2></div>
<div class="sec1">
    <div class="container">
         <div class="row">
            <div class="part col-7 bg-primary">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input placeholder="0000" type="text" class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
...
<div class="submit text-center">
    ...
    <button type="submit" class="btn btn-outline-primary btn-lg px-5 mx-5">Save Contractor</button>
